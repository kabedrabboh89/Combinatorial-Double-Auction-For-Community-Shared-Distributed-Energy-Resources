...
fig, (ax1, ax2, ax3, ax4, ax5) = plt.subplots\
    (nrows=5, sharex=True, subplot_kw=dict(frameon=False), figsize=(7, 14))

plt.subplots_adjust(hspace=.0, left=0.225, right=0.98, top=1, bottom=0.04)
...
ax2.plot(hour, cum_cost_case1, color='darkred', label='Baseline system', drawstyle='steps-post')
...
ax3.plot(hour, cum_revenue1_case1, color='darkred', label='Baseline system', drawstyle='steps-post')
...
ax4.plot(hour, cum_revenue2_case1, color='darkred', label='Baseline system', drawstyle='steps-post')
...
ax5.plot(hour, cum_revenue3_case1, color='darkred', label='Baseline system', drawstyle='steps-post')
