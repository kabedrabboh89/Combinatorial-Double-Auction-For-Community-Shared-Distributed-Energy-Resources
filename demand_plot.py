...
plt.subplots_adjust(hspace=.0, left=0.195, right=0.98, top=1, bottom=0.04)
...
ax3.plot(hour, nada, color='white', label=r'$k$'+'-double', drawstyle='steps-post')
...
ax3.plot(hour, nada, color='white', label='CDA', drawstyle='steps-post')
...
ax3.legend(loc='upper left', fontsize='12', ncols=3)
